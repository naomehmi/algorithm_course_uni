...
a. calculate the final grade (FG) of a student based on their assignment score (X), midterm exam score (Y), and final exam score (Z) with this formula: FG = (0.4) * X + (0.3) * Y + (0.3) * Z.
